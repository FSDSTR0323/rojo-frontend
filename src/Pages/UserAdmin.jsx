        ...
        <TableContainer component={Paper} sx={{ marginTop: 20 }}>
            <Table sx={{ minWidth: 750 }}>
                ...
                {userList.map((user) => (
                  <TableRow key={user.id}>
                    ...
                    >
                      ...
                      <Button variant="outlined" sx={{ textTransform: 'none', border: 'none', maxWidth:'16px', minWidth: '16px' }}> 
                        <Delete />
                      </Button>
                    </TableCell>
                  </TableRow>
              ...
              <TableRow>
                ...
                <TableCell sx={{ textAlign: 'left' }}>Vicente Chamorro</TableCell>
                <TableCell sx={{ textAlign: 'left' }}>Chef</TableCell>
                <TableCell sx={{ textAlign: 'right' }}>
                <Button
                  variant="outlined"
                  sx={{ textTransform: 'none', mr: 1, border: 'none', maxWidth:'16px', minWidth: '16px' }}
                  onClick={() => openEditModalHandler({ id: 1, firstName: 'Marisa', lastName: 'Vicente Chamorro', role: 'Chef' })}
                >
                  <Edit />
                </Button>
                  <Button variant="outlined" sx={{ textTransform: 'none', border: 'none', maxWidth:'16px', minWidth: '16px' }}>
