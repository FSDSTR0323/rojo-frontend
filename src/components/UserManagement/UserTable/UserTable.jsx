...
class UserTable extends Component {
  ...
  render() {
    const { userList, openUserDetailsModalHandler, deleteUserHandler, openEditModalHandler } = this.props;
        ...
        <Table sx={{ minWidth: 750 }}>
          <TableHead sx={{ backgroundColor: '#f1f3f4' }}>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: 'bold', textAlign: 'right', width: '220px' }}>Actions</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
              ...
              userList.map((user) => (
                <TableRow key={user._id}>
                  ...
                  <TableCell sx={{ textAlign: 'right' }}>
                    <Button
                      variant="outlined"
                      sx={{ textTransform: 'none', border: 'none', justifyContent: 'space-around' }}
